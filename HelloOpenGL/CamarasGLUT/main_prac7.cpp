...
GLfloat mat_ambient[] = { 0.1, 0.1, 0.1, 1.0 };					// Color background
GLfloat mat_diffuse[] = { 0.0, 1.0, 0.5, 1.0 };					// Object Color main
GLfloat mat_specular[] = { 1.0, 0.0, 0.5, 1.0 };				// Specular color
GLfloat mat_shininess[] = { 100.0 };							// 1 to greatest

GLfloat mat_ambient1[] = { 0.1, 0.1, 0.1, 1.0 };					// Color background
GLfloat mat_diffuse1[] = { 1.0, 0.0, 0.0, 1.0 };					// Object Color main
GLfloat mat_specular1[] = { 0.0, 1.0, 1.0, 1.0 };				// Specular color
GLfloat mat_shininess1[] = { 50.0 };							// 1 to greatest
